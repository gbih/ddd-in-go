// Domain Modeling Made Functional, p.67-69
...
// rough equivalent, not wrapping around the primitive types
...
var ConvertPaymentCurrency = func() {
	...
	// payment = Payment{Amount: 34.3,
	// 	Currency{Currency: "EUR"},
	// 	Method{PaymentMethod: "CASH"}
	// }
	//payment = Payment{Amount: 34.3, Currency{Currency: "EUR"}, Method: PaymentMethod(nil)}
