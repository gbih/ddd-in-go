...
// func chooseAppleVariety(i AppleVariety) {
// 	switch i.(type) {
// 	case GoldenDelicious:
// 		fmt.Println("SELECT: GoldenDelicious")
// 	case GrannySmith:
// 		fmt.Println("SELECT: GrannySmith")
// 	case Fuji:
// 		fmt.Println("SELECT: Fuji")
// 	}
// }
...
// func chooseBananaVariety(i BananaVariety) {
// 	switch i.(type) {
// 	case Cavendish:
// 		fmt.Println("SELECT: Cavendish")
// 	case GrosMichel:
// 		fmt.Println("SELECT: GrosMichel")
// 	case Manzano:
// 		fmt.Println("SELECT: Manzano")
// 	}
// }
